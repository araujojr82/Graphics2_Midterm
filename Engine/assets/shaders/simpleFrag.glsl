...
//	matDiffuse.rgb += cubeMapSampleColour.rgb;
	...
	// HACK TO HAVE ONLY THE MATERIAL COLOR ON SCREEN (NO LIGHTING) 
	//fragOut.colour.rgb = materialDiffuse.rgb;
	//fragOut.colour.r = 1.0;
	//fragOut.colour.g = 1.0;
	//fragOut.colour.b = 1.0;
